...
const GPageExtractSectionFormat _$gPageExtractSectionFormatplain =
    const GPageExtractSectionFormat._('plain');
const GPageExtractSectionFormat _$gPageExtractSectionFormatraw =
    const GPageExtractSectionFormat._('raw');
const GPageExtractSectionFormat _$gPageExtractSectionFormatwiki =
    const GPageExtractSectionFormat._('wiki');

GPageExtractSectionFormat _$gPageExtractSectionFormatValueOf(String name) {
  switch (name) {
    case 'plain':
      return _$gPageExtractSectionFormatplain;
    case 'raw':
      return _$gPageExtractSectionFormatraw;
    case 'wiki':
      return _$gPageExtractSectionFormatwiki;
    default:
      throw new ArgumentError(name);
  }
}

final BuiltSet<GPageExtractSectionFormat> _$gPageExtractSectionFormatValues =
    new BuiltSet<GPageExtractSectionFormat>(const <GPageExtractSectionFormat>[
  _$gPageExtractSectionFormatplain,
  _$gPageExtractSectionFormatraw,
  _$gPageExtractSectionFormatwiki,
]);

Serializer<GCacheControlScope> _$gCacheControlScopeSerializer =
    new _$GCacheControlScopeSerializer();
Serializer<GPageExtractSectionFormat> _$gPageExtractSectionFormatSerializer =
    new _$GPageExtractSectionFormatSerializer();
...
class _$GPageExtractSectionFormatSerializer
    implements PrimitiveSerializer<GPageExtractSectionFormat> {
  @override
  final Iterable<Type> types = const <Type>[GPageExtractSectionFormat];
  @override
  final String wireName = 'GPageExtractSectionFormat';

  @override
  Object serialize(Serializers serializers, GPageExtractSectionFormat object,
          {FullType specifiedType = FullType.unspecified}) =>
      object.name;

  @override
  GPageExtractSectionFormat deserialize(
          Serializers serializers, Object serialized,
          {FullType specifiedType = FullType.unspecified}) =>
      GPageExtractSectionFormat.valueOf(serialized as String);
}
